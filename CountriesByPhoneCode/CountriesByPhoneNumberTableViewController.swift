//
//  CountriesByPhoneNumberTableViewController.swift
...
class CountriesByPhoneNumberTableViewController: UITableViewController {
    ...
    private func setCountries() {
        countries = Countries.getCountriesByPhoneCode()
    }
